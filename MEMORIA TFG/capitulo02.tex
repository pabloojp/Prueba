...
\begin{minipage}{0.3\textwidth}
    ...
    \captionof{figure}{Relación entre Ciencia de Datos, Inteligencia Artificial, Machine Learning y Deep Learning.}
    \label{fig: ia}
\end{minipage}
...
El autoencoder ilustrado en la figura \ref{fig:AE_architecture} puede modelarse mediante la ecuación (\ref{eq:ae_model}).
